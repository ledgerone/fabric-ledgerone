...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n*org.ledgerone.fabric_ledgerone.protos.peerB\014AdminPackageZ1github.com/ledgerone/fabric-ledgerone/protos/peer'))
