...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n)org.ledgerone.fabric_ledgerone.protos.mspB\020MspConfigPackageZ0github.com/ledgerone/fabric-ledgerone/protos/msp'))
