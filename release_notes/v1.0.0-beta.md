...
Java Chaincode support has been disabled until post 1.0.0 as it is not yet fully mature. It may be re-enabled for experimentation by cloning the ledgerone/fabric repository, reversing [this commit](https://github.com/ledgerone/fabric-ledgerone/commit/29e0c40) and building your own fork.
