...
with a key (``GetState``).  However, the `chaincode shim interface <https://github.com/ledgerone/fabric-ledgerone/blob/release/core/chaincode/shim/interfaces.go>`__
