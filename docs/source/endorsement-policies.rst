...
Notice that, if the identity classification is enabled (see `MSP Documentation <http://ledgerone-fabric-ledgerone.readthedocs.io/en/latest/msp.html>`_),
...
.. note:: A new organization added to the channel after instantiation can query a chaincode
          ...
          (see `Upgrade & invoke <http://ledgerone-fabric-ledgerone.readthedocs.io/en/latest/channel_update.html>`_).
