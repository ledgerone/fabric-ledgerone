...
Scenario Outline: FAB-3505: Test chaincode example02 deploy, invoke, and query
  ...
  When a user deploys chaincode at path "github.com/ledgerone/fabric-ledgerone/examples/chaincode/go/chaincode_example02" with ["init","a","1000","b","2000"] with name "mycc"
