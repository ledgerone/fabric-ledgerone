...
package org.ledgerone.fabric_ledgerone.shim.impl;

import static java.lang.String.format;
import static org.ledgerone.fabric_ledgerone.protos.peer.ChaincodeShim.ChaincodeMessage.Type.COMPLETED;
import static org.ledgerone.fabric_ledgerone.protos.peer.ChaincodeShim.ChaincodeMessage.Type.DEL_STATE;
import static org.ledgerone.fabric_ledgerone.protos.peer.ChaincodeShim.ChaincodeMessage.Type.ERROR;
import static org.ledgerone.fabric_ledgerone.protos.peer.ChaincodeShim.ChaincodeMessage.Type.GET_QUERY_RESULT;
import static org.ledgerone.fabric_ledgerone.protos.peer.ChaincodeShim.ChaincodeMessage.Type.GET_STATE;
import static org.ledgerone.fabric_ledgerone.protos.peer.ChaincodeShim.ChaincodeMessage.Type.GET_STATE_BY_RANGE;
import static org.ledgerone.fabric_ledgerone.protos.peer.ChaincodeShim.ChaincodeMessage.Type.INIT;
import static org.ledgerone.fabric_ledgerone.protos.peer.ChaincodeShim.ChaincodeMessage.Type.INVOKE_CHAINCODE;
import static org.ledgerone.fabric_ledgerone.protos.peer.ChaincodeShim.ChaincodeMessage.Type.PUT_STATE;
import static org.ledgerone.fabric_ledgerone.protos.peer.ChaincodeShim.ChaincodeMessage.Type.QUERY_STATE_CLOSE;
import static org.ledgerone.fabric_ledgerone.protos.peer.ChaincodeShim.ChaincodeMessage.Type.QUERY_STATE_NEXT;
import static org.ledgerone.fabric_ledgerone.protos.peer.ChaincodeShim.ChaincodeMessage.Type.READY;
import static org.ledgerone.fabric_ledgerone.protos.peer.ChaincodeShim.ChaincodeMessage.Type.REGISTERED;
import static org.ledgerone.fabric_ledgerone.protos.peer.ChaincodeShim.ChaincodeMessage.Type.RESPONSE;
import static org.ledgerone.fabric_ledgerone.protos.peer.ChaincodeShim.ChaincodeMessage.Type.TRANSACTION;
import static org.ledgerone.fabric_ledgerone.shim.fsm.CallbackType.AFTER_EVENT;
import static org.ledgerone.fabric_ledgerone.shim.fsm.CallbackType.BEFORE_EVENT;
...
import org.ledgerone.fabric_ledgerone.protos.peer.Chaincode.ChaincodeID;
import org.ledgerone.fabric_ledgerone.protos.peer.Chaincode.ChaincodeInput;
import org.ledgerone.fabric_ledgerone.protos.peer.Chaincode.ChaincodeSpec;
import org.ledgerone.fabric_ledgerone.protos.peer.ChaincodeEventPackage.ChaincodeEvent;
import org.ledgerone.fabric_ledgerone.protos.peer.ChaincodeShim.ChaincodeMessage;
import org.ledgerone.fabric_ledgerone.protos.peer.ChaincodeShim.ChaincodeMessage.Type;
import org.ledgerone.fabric_ledgerone.protos.peer.ChaincodeShim.DelState;
import org.ledgerone.fabric_ledgerone.protos.peer.ChaincodeShim.GetQueryResult;
import org.ledgerone.fabric_ledgerone.protos.peer.ChaincodeShim.GetStateByRange;
import org.ledgerone.fabric_ledgerone.protos.peer.ChaincodeShim.GetState;
import org.ledgerone.fabric_ledgerone.protos.peer.ChaincodeShim.PutState;
import org.ledgerone.fabric_ledgerone.protos.peer.ChaincodeShim.QueryResponse;
import org.ledgerone.fabric_ledgerone.protos.peer.ChaincodeShim.QueryStateClose;
import org.ledgerone.fabric_ledgerone.protos.peer.ChaincodeShim.QueryStateNext;
import org.ledgerone.fabric_ledgerone.protos.peer.ProposalResponsePackage.Response;
import org.ledgerone.fabric_ledgerone.protos.peer.ProposalResponsePackage.Response.Builder;
import org.ledgerone.fabric_ledgerone.shim.Chaincode;
import org.ledgerone.fabric_ledgerone.shim.ChaincodeBase;
import org.ledgerone.fabric_ledgerone.shim.ChaincodeStub;
import org.ledgerone.fabric_ledgerone.shim.fsm.CBDesc;
import org.ledgerone.fabric_ledgerone.shim.fsm.Event;
import org.ledgerone.fabric_ledgerone.shim.fsm.EventDesc;
import org.ledgerone.fabric_ledgerone.shim.fsm.FSM;
import org.ledgerone.fabric_ledgerone.shim.fsm.exceptions.CancelledException;
import org.ledgerone.fabric_ledgerone.shim.fsm.exceptions.NoTransitionException;
import org.ledgerone.fabric_ledgerone.shim.helper.Channel;
...
public class Handler {
	...
	// handleMessage message handles loop for org.ledgerone.fabric_ledgerone.shim side
	...
	public synchronized void handleMessage(ChaincodeMessage message) throws Exception {
		...
		if (fsm.eventCannotOccur(message.getType().toString())) {
			String errStr = String.format("[%s]Chaincode handler org.ledgerone.fabric_ledgerone.shim.fsm cannot handle message (%s) with payload size (%d) while in state: %s", message.getTxid(), message.getType(), message.getPayload().size(), fsm.current());
